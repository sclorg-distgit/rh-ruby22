...
%changelog
* Tue Mar 10 2015 Vít Ondruch <vondruch@redhat.com> - 2.0-6
- Rebuild to remove 'scls' direcotories created by scl-utils.
  Resolves: rhbz#1200061

* Thu Feb 05 2015 Vít Ondruch <vondruch@redhat.com> - 2.0-5
- Fix man5 dir directory ownership.

* Fri Jan 30 2015 Vít Ondruch <vondruch@redhat.com> - 2.0-4
- Add SystemTap paths.

* Fri Jan 09 2015 Vít Ondruch <vondruch@redhat.com> - 2.0-3
- Fix -scldevel macros.

* Wed Jan 07 2015 Vít Ondruch <vondruch@redhat.com> - 2.0-2
- Add NFS support.

* Thu Dec 11 2014 Vít Ondruch <vondruch@redhat.com> - 2.0-1
- Update metapackage from ruby200 to rh-ruby22.
